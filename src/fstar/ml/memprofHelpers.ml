(* This file is taken from Jacques-Henri Jourdan's statistical memory profiler:
   https://raw.githubusercontent.com/jhjourdan/ocaml/memprof/memprofHelpers.ml

   It only works with OCaml opam switch 4.03.0+statistical-memprof

   FOR INTERNAL DEBUGGING PURPOSES ONLY
   NOT FOR REDISTRIBUTION

   DO NOT MERGE THIS BRANCH (taramana_statistical_memprof or its
   descendants) INTO MASTER or any other release branch.
