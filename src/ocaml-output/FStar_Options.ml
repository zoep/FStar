...
let uu___is_Z3 : solver -> Prims.bool =
  fun projectee  -> match projectee with | Z3  -> true | uu____137 -> false 
let uu___is_CVC4 : solver -> Prims.bool =
  fun projectee  -> match projectee with | CVC4  -> true | uu____141 -> false 
let __unit_tests__ : Prims.bool FStar_ST.ref = FStar_Util.mk_ref false 
let __unit_tests : Prims.unit -> Prims.bool =
  fun uu____147  -> FStar_ST.read __unit_tests__ 
let __set_unit_tests : Prims.unit -> Prims.unit =
  fun uu____152  -> FStar_ST.write __unit_tests__ true 
let __clear_unit_tests : Prims.unit -> Prims.unit =
  fun uu____157  -> FStar_ST.write __unit_tests__ false 
let as_bool : option_val -> Prims.bool =
  fun uu___49_162  ->
    match uu___49_162 with
    | Bool b -> b
    | uu____164 -> failwith "Impos: expected Bool"
  
let as_int : option_val -> Prims.int =
  fun uu___50_167  ->
    match uu___50_167 with
    | Int b -> b
    | uu____169 -> failwith "Impos: expected Int"
  
let as_string : option_val -> Prims.string =
  fun uu___51_172  ->
    match uu___51_172 with
    | String b -> b
    | Path b -> FStar_Common.try_convert_file_name_to_mixed b
    | uu____175 -> failwith "Impos: expected String"
  
let as_list as_t uu___52_191 =
  match uu___52_191 with
  | List ts -> FStar_All.pipe_right ts (FStar_List.map as_t)
  | uu____198 -> failwith "Impos: expected List" 
let as_option as_t uu___53_215 =
  match uu___53_215 with
  | Unset  -> FStar_Pervasives_Native.None
  | v1 -> let uu____219 = as_t v1  in FStar_Pervasives_Native.Some uu____219 
let fstar_options : option_val FStar_Util.smap Prims.list FStar_ST.ref =
  FStar_Util.mk_ref [] 
let peek : Prims.unit -> option_val FStar_Util.smap =
  fun uu____231  ->
    let uu____232 = FStar_ST.read fstar_options  in FStar_List.hd uu____232
  
let pop : Prims.unit -> Prims.unit =
  fun uu____242  ->
    let uu____243 = FStar_ST.read fstar_options  in
    match uu____243 with
    | [] -> failwith "TOO MANY POPS!"
    | uu____251::[] -> failwith "TOO MANY POPS!"
    | uu____255::tl1 -> FStar_ST.write fstar_options tl1
  
let push : Prims.unit -> Prims.unit =
  fun uu____267  ->
    let uu____268 =
      let uu____271 =
        let uu____273 = peek ()  in FStar_Util.smap_copy uu____273  in
      let uu____275 = FStar_ST.read fstar_options  in uu____271 :: uu____275
       in
    FStar_ST.write fstar_options uu____268
  
let set_option : Prims.string -> option_val -> Prims.unit =
  fun k  ->
    fun v1  -> let uu____293 = peek ()  in FStar_Util.smap_add uu____293 k v1
  
let set_option' :
  (Prims.string,option_val) FStar_Pervasives_Native.tuple2 -> Prims.unit =
  fun uu____299  -> match uu____299 with | (k,v1) -> set_option k v1 
...
let add_light_off_file : Prims.string -> Prims.unit =
  fun filename  ->
    let uu____327 =
      let uu____329 = FStar_ST.read light_off_files  in filename :: uu____329
       in
    FStar_ST.write light_off_files uu____327
...
let get_option : Prims.string -> option_val =
  fun s  ->
    let uu____540 =
      let uu____542 = peek ()  in FStar_Util.smap_try_find uu____542 s  in
...
let get_admit_smt_queries : Prims.unit -> Prims.bool =
  fun uu____564  -> lookup_opt "admit_smt_queries" as_bool 
let get_check_hints : Prims.unit -> Prims.bool =
  fun uu____567  -> lookup_opt "check_hints" as_bool 
let get_codegen : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____571  -> lookup_opt "codegen" (as_option as_string) 
let get_codegen_lib : Prims.unit -> Prims.string Prims.list =
  fun uu____576  -> lookup_opt "codegen-lib" (as_list as_string) 
let get_debug : Prims.unit -> Prims.string Prims.list =
  fun uu____581  -> lookup_opt "debug" (as_list as_string) 
let get_debug_level : Prims.unit -> Prims.string Prims.list =
  fun uu____586  -> lookup_opt "debug_level" (as_list as_string) 
let get_dep : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____591  -> lookup_opt "dep" (as_option as_string) 
let get_detail_errors : Prims.unit -> Prims.bool =
  fun uu____595  -> lookup_opt "detail_errors" as_bool 
...
let get_lax_except :
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____671  -> lookup_opt "lax_except" (as_option as_string) 
let get_log_queries : Prims.unit -> Prims.bool =
  fun uu____675  -> lookup_opt "log_queries" as_bool 
let get_log_types : Prims.unit -> Prims.bool =
  fun uu____678  -> lookup_opt "log_types" as_bool 
let get_max_fuel : Prims.unit -> Prims.int =
  fun uu____681  -> lookup_opt "max_fuel" as_int 
let get_max_ifuel : Prims.unit -> Prims.int =
  fun uu____684  -> lookup_opt "max_ifuel" as_int 
let get_min_fuel : Prims.unit -> Prims.int =
  fun uu____687  -> lookup_opt "min_fuel" as_int 
let get_MLish : Prims.unit -> Prims.bool =
  fun uu____690  -> lookup_opt "MLish" as_bool 
let get_n_cores : Prims.unit -> Prims.int =
  fun uu____693  -> lookup_opt "n_cores" as_int 
let get_no_default_includes : Prims.unit -> Prims.bool =
  fun uu____696  -> lookup_opt "no_default_includes" as_bool 
let get_no_extract : Prims.unit -> Prims.string Prims.list =
  fun uu____700  -> lookup_opt "no_extract" (as_list as_string) 
let get_no_location_info : Prims.unit -> Prims.bool =
  fun uu____704  -> lookup_opt "no_location_info" as_bool 
let get_odir : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____708  -> lookup_opt "odir" (as_option as_string) 
let get_ugly : Prims.unit -> Prims.bool =
  fun uu____712  -> lookup_opt "ugly" as_bool 
let get_prims : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____716  -> lookup_opt "prims" (as_option as_string) 
let get_print_bound_var_types : Prims.unit -> Prims.bool =
  fun uu____720  -> lookup_opt "print_bound_var_types" as_bool 
let get_print_effect_args : Prims.unit -> Prims.bool =
  fun uu____723  -> lookup_opt "print_effect_args" as_bool 
let get_print_fuels : Prims.unit -> Prims.bool =
  fun uu____726  -> lookup_opt "print_fuels" as_bool 
let get_print_full_names : Prims.unit -> Prims.bool =
  fun uu____729  -> lookup_opt "print_full_names" as_bool 
let get_print_implicits : Prims.unit -> Prims.bool =
  fun uu____732  -> lookup_opt "print_implicits" as_bool 
let get_print_universes : Prims.unit -> Prims.bool =
  fun uu____735  -> lookup_opt "print_universes" as_bool 
let get_print_z3_statistics : Prims.unit -> Prims.bool =
  fun uu____738  -> lookup_opt "print_z3_statistics" as_bool 
let get_prn : Prims.unit -> Prims.bool =
  fun uu____741  -> lookup_opt "prn" as_bool 
let get_record_hints : Prims.unit -> Prims.bool =
  fun uu____744  -> lookup_opt "record_hints" as_bool 
let get_reuse_hint_for :
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____748  -> lookup_opt "reuse_hint_for" (as_option as_string) 
let get_show_signatures : Prims.unit -> Prims.string Prims.list =
  fun uu____753  -> lookup_opt "show_signatures" (as_list as_string) 
let get_silent : Prims.unit -> Prims.bool =
  fun uu____757  -> lookup_opt "silent" as_bool 
let get_smt : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____761  -> lookup_opt "smt" (as_option as_string) 
let get_smtencoding_elim_box : Prims.unit -> Prims.bool =
  fun uu____765  -> lookup_opt "smtencoding.elim_box" as_bool 
let get_smtencoding_nl_arith_repr : Prims.unit -> Prims.string =
  fun uu____768  -> lookup_opt "smtencoding.nl_arith_repr" as_string 
let get_smtencoding_l_arith_repr : Prims.unit -> Prims.string =
  fun uu____771  -> lookup_opt "smtencoding.l_arith_repr" as_string 
let get_smtsolver : Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____775  -> lookup_opt "smt_solver" (as_option as_string) 
let get_split_cases : Prims.unit -> Prims.int =
  fun uu____779  -> lookup_opt "split_cases" as_int 
let get_timing : Prims.unit -> Prims.bool =
  fun uu____782  -> lookup_opt "timing" as_bool 
let get_trace_error : Prims.unit -> Prims.bool =
  fun uu____785  -> lookup_opt "trace_error" as_bool 
let get_unthrottle_inductives : Prims.unit -> Prims.bool =
  fun uu____788  -> lookup_opt "unthrottle_inductives" as_bool 
let get_use_eq_at_higher_order : Prims.unit -> Prims.bool =
  fun uu____791  -> lookup_opt "use_eq_at_higher_order" as_bool 
let get_use_hints : Prims.unit -> Prims.bool =
  fun uu____794  -> lookup_opt "use_hints" as_bool 
let get_use_tactics : Prims.unit -> Prims.bool =
  fun uu____797  ->
    let uu____798 = lookup_opt "no_tactics" as_bool  in
...
let get_verify_all : Prims.unit -> Prims.bool =
  fun uu____809  -> lookup_opt "verify_all" as_bool 
let get_verify_module : Prims.unit -> Prims.string Prims.list =
  fun uu____813  -> lookup_opt "verify_module" (as_list as_string) 
let get___temp_no_proj : Prims.unit -> Prims.string Prims.list =
  fun uu____818  -> lookup_opt "__temp_no_proj" (as_list as_string) 
let get_version : Prims.unit -> Prims.bool =
  fun uu____822  -> lookup_opt "version" as_bool 
let get_warn_default_effects : Prims.unit -> Prims.bool =
  fun uu____825  -> lookup_opt "warn_default_effects" as_bool 
let get_z3cliopt : Prims.unit -> Prims.string Prims.list =
  fun uu____829  -> lookup_opt "z3cliopt" (as_list as_string) 
let get_z3refresh : Prims.unit -> Prims.bool =
  fun uu____833  -> lookup_opt "z3refresh" as_bool 
let get_z3rlimit : Prims.unit -> Prims.int =
  fun uu____836  -> lookup_opt "z3rlimit" as_int 
let get_z3rlimit_factor : Prims.unit -> Prims.int =
  fun uu____839  -> lookup_opt "z3rlimit_factor" as_int 
let get_z3seed : Prims.unit -> Prims.int =
  fun uu____842  -> lookup_opt "z3seed" as_int 
let get_z3timeout : Prims.unit -> Prims.int =
  fun uu____845  -> lookup_opt "z3timeout" as_int 
let get_no_positivity : Prims.unit -> Prims.bool =
  fun uu____848  -> lookup_opt "__no_positivity" as_bool 
let dlevel : Prims.string -> debug_level_t =
  fun uu___54_851  ->
    match uu___54_851 with
    | "Low" -> Low
    | "Medium" -> Medium
    | "High" -> High
    | "Extreme" -> Extreme
...
let debug_level_geq : debug_level_t -> Prims.bool =
  fun l2  ->
    let uu____863 = get_debug_level ()  in
...
let display_version : Prims.unit -> Prims.unit =
  fun uu____890  ->
    let uu____891 =
      let uu____892 = FStar_ST.read _version  in
      let uu____895 = FStar_ST.read _platform  in
      let uu____898 = FStar_ST.read _compiler  in
      let uu____901 = FStar_ST.read _date  in
      let uu____904 = FStar_ST.read _commit  in
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____892
        uu____895 uu____898 uu____901 uu____904
       in
           ...
           (match p with
            | FStar_Getopt.ZeroArgs ig ->
                ...
                then
                  ...
                  FStar_Util.print_string uu____949
                else
                  (let uu____952 =
                     let uu____953 = FStar_Util.colorize_bold flag  in
                     FStar_Util.format2 "  --%s  %s\n" uu____953 doc  in
                   FStar_Util.print_string uu____952)
            | FStar_Getopt.OneArg (uu____954,argname) ->
                if doc = ""
                then
                  let uu____960 =
                    let uu____961 = FStar_Util.colorize_bold flag  in
                    let uu____962 = FStar_Util.colorize_bold argname  in
                    FStar_Util.format2 "  --%s %s\n" uu____961 uu____962  in
                  FStar_Util.print_string uu____960
                else
                  (let uu____964 =
                     let uu____965 = FStar_Util.colorize_bold flag  in
                     let uu____966 = FStar_Util.colorize_bold argname  in
                     FStar_Util.format3 "  --%s %s  %s\n" uu____965 uu____966
                       doc
                      in
                   FStar_Util.print_string uu____964))) specs
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____1001 =
                let uu____1002 = let uu____1005 = f ()  in (name, uu____1005)
                   in
                set_option' uu____1002  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x =
                let uu____1016 = let uu____1019 = f x  in (name, uu____1019)
                   in
                set_option' uu____1016  in
...
let cons_extract_module : Prims.string -> option_val =
  fun s  ->
    let uu____1026 =
      let uu____1028 =
        let uu____1030 = get_extract_module ()  in (FStar_String.lowercase s)
          :: uu____1030
         in
...
let cons_extract_namespace : Prims.string -> option_val =
  fun s  ->
    let uu____1037 =
      let uu____1039 =
        let uu____1041 = get_extract_namespace ()  in
        (FStar_String.lowercase s) :: uu____1041  in
...
let add_extract_module : Prims.string -> Prims.unit =
  fun s  ->
    let uu____1048 = cons_extract_module s  in
    set_option "extract_module" uu____1048
  
let add_extract_namespace : Prims.string -> Prims.unit =
  fun s  ->
    let uu____1052 = cons_extract_namespace s  in
    set_option "extract_namespace" uu____1052
  
let cons_verify_module : Prims.string -> option_val =
  fun s  ->
    let uu____1056 =
      let uu____1058 =
        let uu____1060 = get_verify_module ()  in (FStar_String.lowercase s)
          :: uu____1060
         in
...
let cons_using_facts_from : Prims.string -> option_val =
  fun s  ->
    ...
    (let uu____1068 = get_using_facts_from ()  in
...
let add_verify_module : Prims.string -> Prims.unit =
  fun s  ->
    let uu____1080 = cons_verify_module s  in
    set_option "verify_module" uu____1080
  ...
  fun uu____1094  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1123 = parse_codegen s  in String uu____1123)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1133 =
                  let uu____1135 =
                    let uu____1137 = get_codegen_lib ()  in s :: uu____1137
                     in
                  FStar_All.pipe_right uu____1135
                    (FStar_List.map (fun _0_30  -> String _0_30))
                   in
                List uu____1133)), "[namespace]")),
      ...
      (FStar_Getopt.noshort, "debug",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1150 =
                  let uu____1152 =
                    let uu____1154 = get_debug ()  in x :: uu____1154  in
                  FStar_All.pipe_right uu____1152
                    (FStar_List.map (fun _0_31  -> String _0_31))
                   in
                List uu____1150)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1167 =
                  let uu____1169 =
                    let uu____1171 = get_debug_level ()  in x :: uu____1171
                     in
                  FStar_All.pipe_right uu____1169
                    (FStar_List.map (fun _0_32  -> String _0_32))
                   in
                List uu____1167)), "[Low|Medium|High|Extreme|...]")),
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1208 =
                  let uu____1210 =
                    let uu____1212 = get_dump_module ()  in x :: uu____1212
                     in
                  FStar_All.pipe_right uu____1210
                    (FStar_List.map (fun _0_33  -> String _0_33))
                   in
                FStar_All.pipe_right uu____1208 (fun _0_34  -> List _0_34))),
             "[module name]")), "");
      (FStar_Getopt.noshort, "eager_inference",
        (FStar_Getopt.ZeroArgs ((fun uu____1223  -> Bool true))),
        "Solve all type-inference constraints eagerly; more efficient but at the cost of generality");
      (FStar_Getopt.noshort, "explicit_deps",
        (FStar_Getopt.ZeroArgs ((fun uu____1230  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "hide_genident_nums",
        (FStar_Getopt.ZeroArgs ((fun uu____1268  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "include",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1314 =
                  let uu____1316 =
                    let uu____1318 = get_include ()  in
                    FStar_List.map (fun _0_37  -> String _0_37) uu____1318
                     in
                  FStar_List.append uu____1316 [Path s]  in
                List uu____1314)), "[path]")),
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1336 = FStar_Util.int_of_string x  in
                Int uu____1336)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try initially (default 2)");
      (FStar_Getopt.noshort, "initial_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1346 = FStar_Util.int_of_string x  in
                Int uu____1346)), "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at first (default 1)");
      (FStar_Getopt.noshort, "inline_arith",
        (FStar_Getopt.ZeroArgs ((fun uu____1353  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1392 = FStar_Util.int_of_string x  in
                Int uu____1392)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1402 = FStar_Util.int_of_string x  in
                Int uu____1402)), "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1412 = FStar_Util.int_of_string x  in
                Int uu____1412)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1429 = FStar_Util.int_of_string x  in
                Int uu____1429)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1446 =
                  let uu____1448 =
                    let uu____1450 = get_no_extract ()  in x :: uu____1450
                     in
                  FStar_All.pipe_right uu____1448
                    (FStar_List.map (fun _0_39  -> String _0_39))
                   in
                List uu____1446)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "odir",
        (FStar_Getopt.OneArg
           (((fun p  -> let uu____1470 = validate_dir p  in Path uu____1470)),
      ...
      (FStar_Getopt.noshort, "record_hints",
        (FStar_Getopt.ZeroArgs ((fun uu____1541  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "smt_solver",
        (FStar_Getopt.OneArg
           (((fun s  -> let uu____1622 = parse_solver s  in String uu____1622)),
             "[Z3|CVC4]")),
        "SMT solver in use (usually Z3, but could be CVC4)");
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n1  ->
                let uu____1632 = FStar_Util.int_of_string n1  in
                Int uu____1632)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "trace_error",
        (FStar_Getopt.ZeroArgs ((fun uu____1646  -> Bool true))),
        "Don't print an error message; show an exception trace instead");
      (FStar_Getopt.noshort, "ugly",
        (FStar_Getopt.ZeroArgs ((fun uu____1653  -> Bool true))),
        "Emit output formatted for debugging");
      (FStar_Getopt.noshort, "unthrottle_inductives",
        (FStar_Getopt.ZeroArgs ((fun uu____1660  -> Bool true))),
        "Let the SMT solver unfold inductive types to arbitrary depths (may affect verifier performance)");
      (FStar_Getopt.noshort, "use_eq_at_higher_order",
        (FStar_Getopt.ZeroArgs ((fun uu____1667  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "warn_default_effects",
        (FStar_Getopt.ZeroArgs ((fun uu____1736  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "z3cliopt",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1746 =
                  let uu____1748 =
                    let uu____1750 = get_z3cliopt ()  in
                    FStar_List.append uu____1750 [s]  in
                  FStar_All.pipe_right uu____1748
                    (FStar_List.map (fun _0_47  -> String _0_47))
                   in
                List uu____1746)), "[option]")), "Z3 command line options");
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1770 = FStar_Util.int_of_string s  in
                Int uu____1770)), "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1780 = FStar_Util.int_of_string s  in
                Int uu____1780)), "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1790 = FStar_Util.int_of_string s  in
                Int uu____1790)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "z3timeout",
        (FStar_Getopt.OneArg
           (((fun s  ->
                ...
                (let uu____1801 = FStar_Util.int_of_string s  in
                 Int uu____1801))), "[positive integer]")),
        "Set the Z3 per-query (soft) timeout to [t] seconds (default 5)");
      (FStar_Getopt.noshort, "__no_positivity",
        (FStar_Getopt.ZeroArgs ((fun uu____1808  -> Bool true))),
        "Don't check positivity of inductive types")]
       in
    let uu____1814 = FStar_List.map mk_spec specs1  in
    ('h', "help",
      (FStar_Getopt.ZeroArgs
         (fun x  ->
  ...
  fun s  ->
    ...
    | uu____1835 ->
        (FStar_Util.print_string "Wrong argument to codegen flag\n";
         (let uu____1838 = specs ()  in display_usage_aux uu____1838);
  ...
  fun s  ->
    ...
    | uu____1846 ->
        (FStar_Util.print_string "Wrong argument to 'smt_solver' flag\n";
         (let uu____1849 = specs ()  in display_usage_aux uu____1849);
         FStar_All.exit (Prims.parse_int "1"))

and string_as_bool : Prims.string -> Prims.string -> option_val =
  fun option_name  ->
    fun uu___55_1857  ->
      match uu___55_1857 with
      | "true" -> Bool true
      | "false" -> Bool false
      | uu____1858 ->
          (FStar_Util.print1 "Wrong argument to %s\n" option_name;
           (let uu____1861 = specs ()  in display_usage_aux uu____1861);
           FStar_All.exit (Prims.parse_int "1"))
...
let docs :
  ...
  =
  fun uu____1875  ->
    let uu____1876 = specs ()  in
    FStar_List.map
      (fun uu____1890  ->
         match uu____1890 with
         | (uu____1898,name,uu____1900,doc) -> (name, doc)) uu____1876
  
let settable : Prims.string -> Prims.bool =
  fun uu___56_1906  ->
    match uu___56_1906 with
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1930  ->
          ...
          | (uu____1936,x,uu____1938,uu____1939) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1960  ->
          ...
          | (uu____1966,x,uu____1968,uu____1969) -> resettable x))
  
let display_usage : Prims.unit -> Prims.unit =
  fun uu____1974  ->
    let uu____1975 = specs ()  in display_usage_aux uu____1975
  
let fstar_home : Prims.unit -> Prims.string =
  fun uu____1984  ->
    let uu____1985 = get_fstar_home ()  in
...
let uu___is_File_argument : Prims.exn -> Prims.bool =
  fun projectee  ->
    ...
    | File_argument uu____1997 -> true
    | uu____1998 -> false
  
let __proj__File_argument__item__uu___ : Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | File_argument uu____2005 -> uu____2005
...
let parse_cmd_line :
  ...
  fun uu____2042  ->
    let res =
      let uu____2044 = specs ()  in
      FStar_Getopt.parse_cmdline uu____2044
        (fun i  ->
           let uu____2047 =
             let uu____2049 = FStar_ST.read file_list_  in
             FStar_List.append uu____2049 [i]  in
           FStar_ST.write file_list_ uu____2047)
       in
    let uu____2057 =
      let uu____2059 = FStar_ST.read file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____2059
       in
    (res, uu____2057)
  
let file_list : Prims.unit -> Prims.string Prims.list =
  fun uu____2068  -> FStar_ST.read file_list_ 
let restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module ()  in
    if should_clear then clear () else init ();
    (let r =
       let uu____2080 = specs ()  in
       FStar_Getopt.parse_cmdline uu____2080 (fun x  -> ())  in
     (let uu____2084 =
        let uu____2087 =
          let uu____2088 =
            FStar_List.map (fun _0_48  -> String _0_48) old_verify_module  in
          List uu____2088  in
        ("verify_module", uu____2087)  in
      set_option' uu____2084);
     r)
  
let should_verify : Prims.string -> Prims.bool =
  fun m  ->
    let uu____2093 = get_lax ()  in
    if uu____2093
    then false
    else
      (let uu____2095 = get_verify_all ()  in
       if uu____2095
       then true
       else
         (let uu____2097 = get_verify_module ()  in
          match uu____2097 with
          | [] ->
              let uu____2099 = file_list ()  in
              FStar_List.existsML
                (fun f  ->
                       ...
                       let uu____2105 =
                         let uu____2106 =
                           let uu____2107 = FStar_Util.get_file_extension f1
                              in
                           FStar_String.length uu____2107  in
                         (FStar_String.length f1) - uu____2106  in
                       uu____2105 - (Prims.parse_int "1")  in
                     FStar_String.substring f1 (Prims.parse_int "0")
                       uu____2104
                      in
                   (FStar_String.lowercase f2) = m) uu____2099
          | l -> FStar_List.contains (FStar_String.lowercase m) l))
  
let dont_gen_projectors : Prims.string -> Prims.bool =
  fun m  ->
    let uu____2117 = get___temp_no_proj ()  in
    FStar_List.contains m uu____2117
  
let should_print_message : Prims.string -> Prims.bool =
  fun m  ->
    let uu____2122 = should_verify m  in
    if uu____2122 then m <> "Prims" else false
  
let include_path : Prims.unit -> Prims.string Prims.list =
  fun uu____2127  ->
    let uu____2128 = get_no_default_includes ()  in
    if uu____2128
    then get_include ()
    else
      (let h = fstar_home ()  in
       ...
       let uu____2134 =
         ...
         FStar_All.pipe_right uu____2136
          ...
          in
       let uu____2143 =
         let uu____2145 = get_include ()  in
         FStar_List.append uu____2145 ["."]  in
       FStar_List.append uu____2134 uu____2143)
  
let find_file : Prims.string -> Prims.string FStar_Pervasives_Native.option =
  fun filename  ->
    let uu____2151 = FStar_Util.is_path_absolute filename  in
    if uu____2151
    then
      ...
      (let uu____2156 =
         let uu____2158 = include_path ()  in FStar_List.rev uu____2158  in
       FStar_Util.find_map uu____2156
         (fun p  ->
...
let prims : Prims.unit -> Prims.string =
  fun uu____2166  ->
    let uu____2167 = get_prims ()  in
    match uu____2167 with
    | FStar_Pervasives_Native.None  ->
        let filename = "prims.fst"  in
        let uu____2170 = find_file filename  in
             ...
             let uu____2173 =
               let uu____2174 =
                 FStar_Util.format1
                   ...
                   filename
                  in
               FStar_Util.Failure uu____2174  in
             raise uu____2173)
    | FStar_Pervasives_Native.Some x -> x
  
let prims_basename : Prims.unit -> Prims.string =
  fun uu____2178  ->
    let uu____2179 = prims ()  in FStar_Util.basename uu____2179
  
let pervasives : Prims.unit -> Prims.string =
  fun uu____2182  ->
    let filename = "FStar.Pervasives.fst"  in
    let uu____2184 = find_file filename  in
        ...
        let uu____2187 =
          let uu____2188 =
            FStar_Util.format1
              ...
              filename
             in
          FStar_Util.Failure uu____2188  in
        raise uu____2187
  
let pervasives_basename : Prims.unit -> Prims.string =
  fun uu____2191  ->
    let uu____2192 = pervasives ()  in FStar_Util.basename uu____2192
  
let pervasives_native_basename : Prims.unit -> Prims.string =
  fun uu____2195  ->
    let filename = "FStar.Pervasives.Native.fst"  in
    let uu____2197 = find_file filename  in
        ...
        let uu____2200 =
          let uu____2201 =
            FStar_Util.format1
              ...
              filename
             in
          FStar_Util.Failure uu____2201  in
        raise uu____2200
  
let prepend_output_dir : Prims.string -> Prims.string =
  fun fname  ->
    let uu____2205 = get_odir ()  in
...
let __temp_no_proj : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2211 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____2211 (FStar_List.contains s)
  
let admit_smt_queries : Prims.unit -> Prims.bool =
  fun uu____2216  -> get_admit_smt_queries () 
let check_hints : Prims.unit -> Prims.bool =
  fun uu____2219  -> get_check_hints () 
let codegen : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2223  -> get_codegen () 
let codegen_libs : Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____2228  ->
    let uu____2229 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____2229
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let debug_any : Prims.unit -> Prims.bool =
  fun uu____2238  -> let uu____2239 = get_debug ()  in uu____2239 <> [] 
let debug_at_level : Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      ((modul = "") ||
         (let uu____2248 = get_debug ()  in
          FStar_All.pipe_right uu____2248 (FStar_List.contains modul)))
        && (debug_level_geq level)
  
let dep : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2254  -> get_dep () 
let detail_errors : Prims.unit -> Prims.bool =
  fun uu____2257  -> get_detail_errors () 
let doc : Prims.unit -> Prims.bool = fun uu____2260  -> get_doc () 
let dump_module : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2264 = get_dump_module ()  in
    FStar_All.pipe_right uu____2264 (FStar_List.contains s)
  
let eager_inference : Prims.unit -> Prims.bool =
  fun uu____2269  -> get_eager_inference () 
let explicit_deps : Prims.unit -> Prims.bool =
  fun uu____2272  -> get_explicit_deps () 
let extract_all : Prims.unit -> Prims.bool =
  fun uu____2275  -> get_extract_all () 
let fs_typ_app : Prims.string -> Prims.bool =
  fun filename  ->
    let uu____2279 = FStar_ST.read light_off_files  in
    FStar_List.contains filename uu____2279
  
let full_context_dependency : Prims.unit -> Prims.bool =
  fun uu____2286  -> true 
let hide_genident_nums : Prims.unit -> Prims.bool =
  fun uu____2289  -> get_hide_genident_nums () 
let hide_uvar_nums : Prims.unit -> Prims.bool =
  fun uu____2292  -> get_hide_uvar_nums () 
let hint_info : Prims.unit -> Prims.bool =
  fun uu____2295  -> get_hint_info () 
let hint_file : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2299  -> get_hint_file () 
let ide : Prims.unit -> Prims.bool = fun uu____2302  -> get_ide () 
let indent : Prims.unit -> Prims.bool = fun uu____2305  -> get_indent () 
let initial_fuel : Prims.unit -> Prims.int =
  fun uu____2308  ->
    let uu____2309 = get_initial_fuel ()  in
    let uu____2310 = get_max_fuel ()  in Prims.min uu____2309 uu____2310
  
let initial_ifuel : Prims.unit -> Prims.int =
  fun uu____2313  ->
    let uu____2314 = get_initial_ifuel ()  in
    let uu____2315 = get_max_ifuel ()  in Prims.min uu____2314 uu____2315
  
let interactive : Prims.unit -> Prims.bool =
  fun uu____2318  -> (get_in ()) || (get_ide ()) 
...
let lax_except : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2325  -> get_lax_except () 
let legacy_interactive : Prims.unit -> Prims.bool =
  fun uu____2328  -> get_in () 
let log_queries : Prims.unit -> Prims.bool =
  fun uu____2331  -> get_log_queries () 
let log_types : Prims.unit -> Prims.bool =
  fun uu____2334  -> get_log_types () 
...
let set_ml_ish : Prims.unit -> Prims.unit =
  fun uu____2349  -> set_option "MLish" (Bool true) 
let n_cores : Prims.unit -> Prims.int = fun uu____2352  -> get_n_cores () 
let no_default_includes : Prims.unit -> Prims.bool =
  fun uu____2355  -> get_no_default_includes () 
let no_extract : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2359 = get_no_extract ()  in
    FStar_All.pipe_right uu____2359 (FStar_List.contains s)
  
let no_location_info : Prims.unit -> Prims.bool =
  fun uu____2364  -> get_no_location_info () 
let output_dir : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2368  -> get_odir () 
let ugly : Prims.unit -> Prims.bool = fun uu____2371  -> get_ugly () 
let print_bound_var_types : Prims.unit -> Prims.bool =
  fun uu____2374  -> get_print_bound_var_types () 
let print_effect_args : Prims.unit -> Prims.bool =
  fun uu____2377  -> get_print_effect_args () 
let print_fuels : Prims.unit -> Prims.bool =
  fun uu____2380  -> get_print_fuels () 
let print_implicits : Prims.unit -> Prims.bool =
  fun uu____2383  -> get_print_implicits () 
let print_real_names : Prims.unit -> Prims.bool =
  fun uu____2386  -> (get_prn ()) || (get_print_full_names ()) 
let print_universes : Prims.unit -> Prims.bool =
  fun uu____2389  -> get_print_universes () 
let print_z3_statistics : Prims.unit -> Prims.bool =
  fun uu____2392  -> get_print_z3_statistics () 
let record_hints : Prims.unit -> Prims.bool =
  fun uu____2395  -> get_record_hints () 
let reuse_hint_for :
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2399  -> get_reuse_hint_for () 
let silent : Prims.unit -> Prims.bool = fun uu____2402  -> get_silent () 
let smtencoding_elim_box : Prims.unit -> Prims.bool =
  fun uu____2405  -> get_smtencoding_elim_box () 
let smtencoding_nl_arith_native : Prims.unit -> Prims.bool =
  fun uu____2408  ->
    let uu____2409 = get_smtencoding_nl_arith_repr ()  in
    uu____2409 = "native"
  
let smtencoding_nl_arith_wrapped : Prims.unit -> Prims.bool =
  fun uu____2412  ->
    let uu____2413 = get_smtencoding_nl_arith_repr ()  in
    uu____2413 = "wrapped"
  
let smtencoding_nl_arith_default : Prims.unit -> Prims.bool =
  fun uu____2416  ->
    let uu____2417 = get_smtencoding_nl_arith_repr ()  in
    uu____2417 = "boxwrap"
  
let smtencoding_l_arith_native : Prims.unit -> Prims.bool =
  fun uu____2420  ->
    let uu____2421 = get_smtencoding_l_arith_repr ()  in
    uu____2421 = "native"
  
let smtencoding_l_arith_default : Prims.unit -> Prims.bool =
  fun uu____2424  ->
    let uu____2425 = get_smtencoding_l_arith_repr ()  in
    uu____2425 = "boxwrap"
  
let smt_solver : Prims.unit -> solver =
  fun uu____2428  ->
    let uu____2429 = get_smtsolver ()  in
    match uu____2429 with
    | FStar_Pervasives_Native.None  -> Z3
    | FStar_Pervasives_Native.Some "z3" -> Z3
    | FStar_Pervasives_Native.Some "Z3" -> Z3
    | FStar_Pervasives_Native.Some "cvc4" -> CVC4
    | FStar_Pervasives_Native.Some "CVC4" -> CVC4
    | uu____2431 -> failwith "Invalid SMT solver"
  
let split_cases : Prims.unit -> Prims.int =
  fun uu____2435  -> get_split_cases () 
let timing : Prims.unit -> Prims.bool = fun uu____2438  -> get_timing () 
let trace_error : Prims.unit -> Prims.bool =
  fun uu____2441  -> get_trace_error () 
let unthrottle_inductives : Prims.unit -> Prims.bool =
  fun uu____2444  -> get_unthrottle_inductives () 
let use_eq_at_higher_order : Prims.unit -> Prims.bool =
  fun uu____2447  -> get_use_eq_at_higher_order () 
let use_hints : Prims.unit -> Prims.bool =
  fun uu____2450  -> get_use_hints () 
let use_tactics : Prims.unit -> Prims.bool =
  fun uu____2453  -> get_use_tactics () 
let using_facts_from :
  Prims.unit -> Prims.string Prims.list FStar_Pervasives_Native.option =
  fun uu____2458  -> get_using_facts_from () 
let verify_all : Prims.unit -> Prims.bool =
  fun uu____2461  -> get_verify_all () 
let verify_module : Prims.unit -> Prims.string Prims.list =
  fun uu____2465  -> get_verify_module () 
let warn_default_effects : Prims.unit -> Prims.bool =
  fun uu____2468  -> get_warn_default_effects () 
let solver_exe : Prims.unit -> Prims.string =
  fun uu____2471  ->
    let uu____2472 = get_smt ()  in
    match uu____2472 with
    | FStar_Pervasives_Native.None  ->
        let uu____2474 =
          let uu____2475 = smt_solver ()  in
          match uu____2475 with | Z3  -> "z3" | CVC4  -> "cvc4"  in
        FStar_All.pipe_right uu____2474 FStar_Platform.exe
    | FStar_Pervasives_Native.Some s -> s
  
let z3_cliopt : Prims.unit -> Prims.string Prims.list =
  fun uu____2480  -> get_z3cliopt () 
let z3_refresh : Prims.unit -> Prims.bool =
  fun uu____2483  -> get_z3refresh () 
let z3_rlimit : Prims.unit -> Prims.int = fun uu____2486  -> get_z3rlimit () 
let z3_rlimit_factor : Prims.unit -> Prims.int =
  fun uu____2489  -> get_z3rlimit_factor () 
let z3_seed : Prims.unit -> Prims.int = fun uu____2492  -> get_z3seed () 
let z3_timeout : Prims.unit -> Prims.int =
  fun uu____2495  -> get_z3timeout () 
let no_positivity : Prims.unit -> Prims.bool =
  fun uu____2498  -> get_no_positivity () 
let should_extract : Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2502 = no_extract m  in Prims.op_Negation uu____2502) &&
      ((extract_all ()) ||
         (let uu____2503 = get_extract_module ()  in
          match uu____2503 with
          | [] ->
              let uu____2505 = get_extract_namespace ()  in
