...
| uu____423 -> begin
(match ((FStar_Util.starts_with a.FStar_SMTEncoding_Term.assumption_name "__")) with
| true -> begin
...
in ((uu____704), (FStar_Pervasives_Native.None), ("__MaxFuel_assumption")))
...
in ((uu____719), (FStar_Pervasives_Native.None), ("__MaxIFuel_assumption")))
