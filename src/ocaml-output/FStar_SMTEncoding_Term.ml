...
let uu___is_Get_value : decl  ->  Prims.bool = (fun projectee -> (match (projectee) with
| Get_value (_0) -> begin
true
end
| uu____730 -> begin
...
let __proj__Get_value__item___0 : decl  ->  fv = (fun projectee -> (match (projectee) with
| Get_value (_0) -> begin
_0
end))
...
in (Prims.strcat "__lb" uu____2906))
in (
...
let rec declToSmt : decl  ->  Prims.string = (fun decl -> (
...
let uu____2971 = (FStar_Options.log_queries ())
in (match (uu____2971) with
| true -> begin
(

let uu____2972 = (FStar_All.pipe_right (FStar_Util.splitlines c) (fun uu___91_2974 -> (match (uu___91_2974) with
| [] -> begin
""
end
| (h)::t -> begin
...
let uu____2988 = (caption_to_string c)
in (

let uu____2989 = (strSort retsort)
in (FStar_Util.format4 "%s(declare-fun %s (%s) %s)" uu____2988 f (FStar_String.concat " " l) uu____2989))))
end
| DefineFun (f, arg_sorts, retsort, body, c) -> begin
(

let uu____2997 = (name_macro_binders arg_sorts)
...
let uu____3015 = (FStar_List.map (fun x -> (mkFreeV x norng)) names)
in (inst uu____3015 body))
in (

let uu____3022 = (caption_to_string c)
in (

let uu____3023 = (strSort retsort)
in (

let uu____3024 = (termToSmt (escape f) body1)
in (FStar_Util.format5 "%s(define-fun %s (%s) %s\n %s)" uu____3022 f (FStar_String.concat " " binders) uu____3023 uu____3024)))))
end))
end
| Assume (a) -> begin
(

let fact_ids_to_string = (fun ids -> (FStar_All.pipe_right ids (FStar_List.map (fun uu___92_3035 -> (match (uu___92_3035) with
| Name (n1) -> begin
...
let uu____3040 = (FStar_Options.log_queries ())
...
let uu____3042 = (fact_ids_to_string a.assumption_fact_ids)
in (FStar_String.concat "; " uu____3042))
...
let uu____3046 = (caption_to_string a.assumption_caption)
in (

let uu____3047 = (termToSmt n1 a.assumption_term)
in (FStar_Util.format4 "%s%s(assert (! %s\n:named %s))" uu____3046 fids uu____3047 n1))))))
end
| Get_value (x, uu____3049) -> begin
(FStar_Util.format1 "(get-value %s)" x)
end
| Echo (s) -> begin
(FStar_Util.format1 "(echo \"%s\")" s)
end
| RetainAssumptions (uu____3051) -> begin
""
end
| CheckSat -> begin
"(check-sat)"
...
and prelude : Prims.unit  ->  Prims.string = (fun uu____3055 -> (
...
let uu____3238 = (FStar_All.pipe_right constrs (FStar_List.collect constructor_to_decl))
in (FStar_All.pipe_right uu____3238 (FStar_List.map declToSmt)))
in (FStar_All.pipe_right uu____3236 (FStar_String.concat "\n")))
in (
...
let uu____3269 = (mkInteger' i norng)
in (uu____3269)::[])
in (("Tm_uvar"), (uu____3267)))
in (mkApp uu____3263 r)))
...
| App (Var ("Prims.b2t"), ({tm = App (Var ("Prims.op_Equality"), (uu____3331)::(t1)::(t2)::[]); freevars = uu____3334; rng = uu____3335})::[]) -> begin
(mkEq ((t1), (t2)) t.rng)
end
| App (Var ("Prims.b2t"), ({tm = App (Var ("Prims.op_disEquality"), (uu____3342)::(t1)::(t2)::[]); freevars = uu____3345; rng = uu____3346})::[]) -> begin
(

let uu____3353 = (mkEq ((t1), (t2)) norng)
in (mkNot uu____3353 t.rng))
end
| App (Var ("Prims.b2t"), ({tm = App (Var ("Prims.op_LessThanOrEqual"), (t1)::(t2)::[]); freevars = uu____3356; rng = uu____3357})::[]) -> begin
(

let uu____3364 = (

let uu____3367 = (unboxInt t1)
in (

let uu____3368 = (unboxInt t2)
in ((uu____3367), (uu____3368))))
in (mkLTE uu____3364 t.rng))
end
| App (Var ("Prims.b2t"), ({tm = App (Var ("Prims.op_LessThan"), (t1)::(t2)::[]); freevars = uu____3371; rng = uu____3372})::[]) -> begin
(

let uu____3379 = (

let uu____3382 = (unboxInt t1)
in (

let uu____3383 = (unboxInt t2)
in ((uu____3382), (uu____3383))))
in (mkLT uu____3379 t.rng))
end
| App (Var ("Prims.b2t"), ({tm = App (Var ("Prims.op_GreaterThanOrEqual"), (t1)::(t2)::[]); freevars = uu____3386; rng = uu____3387})::[]) -> begin
(

let uu____3394 = (

let uu____3397 = (unboxInt t1)
in (

let uu____3398 = (unboxInt t2)
in ((uu____3397), (uu____3398))))
in (mkGTE uu____3394 t.rng))
end
| App (Var ("Prims.b2t"), ({tm = App (Var ("Prims.op_GreaterThan"), (t1)::(t2)::[]); freevars = uu____3401; rng = uu____3402})::[]) -> begin
(

let uu____3409 = (

let uu____3412 = (unboxInt t1)
in (

let uu____3413 = (unboxInt t2)
in ((uu____3412), (uu____3413))))
in (mkGT uu____3409 t.rng))
end
| App (Var ("Prims.b2t"), ({tm = App (Var ("Prims.op_AmpAmp"), (t1)::(t2)::[]); freevars = uu____3416; rng = uu____3417})::[]) -> begin
(

let uu____3424 = (

let uu____3427 = (unboxBool t1)
in (

let uu____3428 = (unboxBool t2)
in ((uu____3427), (uu____3428))))
in (mkAnd uu____3424 t.rng))
end
| App (Var ("Prims.b2t"), ({tm = App (Var ("Prims.op_BarBar"), (t1)::(t2)::[]); freevars = uu____3431; rng = uu____3432})::[]) -> begin
(

let uu____3439 = (

let uu____3442 = (unboxBool t1)
in (

let uu____3443 = (unboxBool t2)
in ((uu____3442), (uu____3443))))
in (mkOr uu____3439 t.rng))
end
| App (Var ("Prims.b2t"), ({tm = App (Var ("Prims.op_Negation"), (t1)::[]); freevars = uu____3445; rng = uu____3446})::[]) -> begin
(

let uu____3453 = (unboxBool t1)
in (mkNot uu____3453 t1.rng))
end
| App (Var ("Prims.b2t"), (t1)::[]) -> begin
(

let uu___93_3456 = (unboxBool t1)
in {tm = uu___93_3456.tm; freevars = uu___93_3456.freevars; rng = t.rng})
end
| uu____3459 -> begin
(mkApp (("Valid"), ((t)::[])) t.rng)
end))
...
let uu____3488 = (FStar_Options.unthrottle_inductives ())
...
let uu____3558 = (mkInteger' i norng)
in (uu____3558)::[])
in (("FString_const"), (uu____3556)))
in (mkApp uu____3552 r)))


let mk_Precedes : term  ->  term  ->  FStar_Range.range  ->  term = (fun x1 x2 r -> (

let uu____3569 = (mkApp (("Precedes"), ((x1)::(x2)::[])) r)
in (FStar_All.pipe_right uu____3569 mk_Valid)))
...
let uu____3592 = (n_fuel (n1 - (Prims.parse_int "1")))
in (uu____3592)::[])
in (("SFuel"), (uu____3590)))
in (mkApp uu____3586 norng))
end))
...
let uu____3615 = (mkAnd ((p11), (p21)) r)
in FStar_Pervasives_Native.Some (uu____3615))
end
...
let uu____3649 = (mkTrue r)
in (FStar_List.fold_right (fun p1 p2 -> (mkAnd ((p1), (p2)) r)) l uu____3649)))


let mk_or_l : term Prims.list  ->  FStar_Range.range  ->  term = (fun l r -> (

let uu____3660 = (mkFalse r)
in (FStar_List.fold_right (fun p1 p2 -> (mkOr ((p1), (p2)) r)) l uu____3660)))


let mk_haseq : term  ->  term = (fun t -> (

let uu____3666 = (mkApp (("Prims.hasEq"), ((t)::[])) t.rng)
in (mk_Valid uu____3666)))
...
let uu____3680 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "(BoundV %s)" uu____3680))
end
| FreeV (fv) -> begin
...
let uu____3688 = (print_smt_term_list l)
in (FStar_Util.format2 "(%s %s)" (op_to_string op) uu____3688))
end
| Labeled (t1, r1, r2) -> begin
(

let uu____3692 = (print_smt_term t1)
in (FStar_Util.format2 "(Labeled \'%s\' %s)" r1 uu____3692))
end
| LblPos (t1, s) -> begin
(

let uu____3695 = (print_smt_term t1)
in (FStar_Util.format2 "(LblPos %s %s)" s uu____3695))
end
| Quant (qop, l, uu____3698, uu____3699, t1) -> begin
(

let uu____3709 = (print_smt_term_list_list l)
in (

let uu____3710 = (print_smt_term t1)
in (FStar_Util.format3 "(%s %s %s)" (qop_to_string qop) uu____3709 uu____3710)))
end
| Let (es, body) -> begin
(

let uu____3715 = (print_smt_term_list es)
in (

let uu____3716 = (print_smt_term body)
in (FStar_Util.format2 "(let %s %s)" uu____3715 uu____3716)))
end))
and print_smt_term_list : term Prims.list  ->  Prims.string = (fun l -> (

let uu____3719 = (FStar_List.map print_smt_term l)
in (FStar_All.pipe_right uu____3719 (FStar_String.concat " "))))
...
let uu____3731 = (print_smt_term_list l1)
in (Prims.strcat uu____3731 " ] "))
in (Prims.strcat "; [ " uu____3730))
in (Prims.strcat s uu____3729))) "" l))
